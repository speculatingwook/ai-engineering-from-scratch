...
PSO와 ACO는 *평가자* 함수만 필요하다. 후보 출력이나 라우팅 결정을 점수화할 수 있다면, 그 공간을 최적화할 수 있다. 그래서 적용 가능성의 문턱이 훨씬 낮다.
...
4. LMPSO (arXiv:2504.09247)을 읽어라. 논문의 "프롬프트로서의 속도"를 코드의 수치 속도에 다시 매핑하라. 시뮬레이션에서 무엇이 손실되고 무엇이 보존되는가?
