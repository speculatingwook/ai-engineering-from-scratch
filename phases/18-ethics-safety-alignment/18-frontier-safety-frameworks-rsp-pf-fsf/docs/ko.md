...
세 개의 2025-2026년 프레임워크는 최신 기술이다 — 불완전하고, 진화 중이며, 연구소 간에 충분히 정렬되어 있어, 이제 거버넌스 질문은 프레임워크가 존재하는지가 아니라 적절한지다.
...
UK AISI, US CAISI, EU AI Office(Lesson 24)가 외부 거버넌스 대응물이다. 연구소 프레임워크는 자발적이고; 규제 프레임워크는 부상 중이다.
