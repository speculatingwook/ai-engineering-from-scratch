...
(function () {
  ...
  var UI = {
    en: {
      ...
      'home.toc.title': 'Curriculum · 20 phases · 503 lessons',
    ...
    ko: {
      ...
      // home / index landing copy
      'home.tagline': '503개 레슨. 20개 페이즈. 단 하나의 프레임워크를 들이기 전에, 모든 알고리즘을 날것의 수학에서부터 만든다.',
      ...
      'home.intro2': '이 커리큘럼은 그 척추(spine)다. 20개 페이즈, 503개 레슨, 네 가지 언어: Python, TypeScript, Rust, Julia. 한쪽 끝에는 선형대수(linear algebra), 다른 쪽 끝에는 자율 군집(autonomous swarm). 모든 알고리즘은 먼저 날것의 수학에서부터 만들어진다. 역전파(backprop). 토크나이저(tokenizer). 어텐션. 에이전트 루프(agent loop). PyTorch가 등장할 즈음이면, 당신은 이미 그것이 내부에서 무엇을 하는지 알게 된다.',
      ...
      'home.toc.title': '커리큘럼 · 20개 페이즈 · 503개 레슨',
